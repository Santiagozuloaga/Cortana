...
- **SubAgentManager**: Sistema de sub-agentes con caché de definiciones (v01.1).
...
- **Optimización Sub-Agentes**: Implementación de caché de mtime para definiciones de agentes.
- **Estabilización Git**: Resolución de bucle de symlinks en `.gitignore`.
- **Benchmark Ollama**: Generación de suite de pruebas de rendimiento para modelos locales.
- **Auditoría Bug #7**: Verificación de integridad de caché vs variables de entorno.
