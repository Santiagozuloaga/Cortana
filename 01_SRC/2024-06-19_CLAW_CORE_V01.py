...
def cmd_voice(args: str, state, config) -> bool:
    ...
    try:
        import importlib; _mod = importlib.import_module('2024-06-19_CLAW_VOICE_V01'); globals()['check_voice_deps'] = getattr(_mod, 'check_voice_deps'); globals()['_voice_input'] = getattr(_mod, 'voice_input')
    except ImportError:
