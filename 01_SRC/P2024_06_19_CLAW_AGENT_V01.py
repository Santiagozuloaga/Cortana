...
from P2024_06_19_CLAW_TOOL_REGISTRY_V01 import get_tool_schemas
from P2024_06_19_CLAW_TOOLS_V01 import execute_tool
import P2024_06_19_CLAW_TOOLS_V01 as _tools_init  # ensure built-in tools are registered on import
from P2024_06_19_CLAW_PROVIDERS_V01 import stream, AssistantTurn, TextChunk, ThinkingChunk, detect_provider
from P2024_06_19_CLAW_COMPACTION_V01 import maybe_compact
...
def _check_permission(tc: dict, config: dict) -> bool:
    ...
    if name in ("Read", "Glob", "Grep", "WebFetch", "WebSearch"):
        return True
    if name == "Bash":
        from P2024_06_19_CLAW_TOOLS_V01 import _is_safe_bash
