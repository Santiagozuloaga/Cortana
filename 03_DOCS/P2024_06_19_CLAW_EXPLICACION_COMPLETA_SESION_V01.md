...
- `clawspring.py` → `P2024_06_19_CLAW_CLAWSPRING_CORE_V01.py`
- `providers.py` → `P2024_06_19_CLAW_PROVIDERS_V01.py`
- `memory/` → `P2024_06_19_CLAW_MEMORY_PACKAGE_V01/`
- `multi_agent/` → `P2024_06_19_CLAW_MULTI_AGENT_V01/`
- `skill/` → `P2024_06_19_CLAW_SKILL_V01/`
- `mcp/` → `P2024_06_19_CLAW_MCP_V01/`
- `plugin/` → `P2024_06_19_CLAW_PLUGIN_V01/`
- `task/` → `P2024_06_19_CLAW_TASK_V01/`
- `voice/` → `P2024_06_19_CLAW_VOICE_V01/`

**Por qué**: Todo el código fuente va en 01_SRC.

**Archivos movidos a 02_TESTS**:
- `tests/` → `02_TESTS/P2024_06_19_CLAW_TESTS_V01/`

**Por qué**: Las pruebas van en su propio directorio.

**Archivos movidos a 03_DOCS**:
- `docs/` → `03_DOCS/P2024_06_19_CLAW_DOCS_V01/`
- `demos/` → `03_DOCS/P2024_06_19_CLAW_DEMOS_V01/`

**Por qué**: Documentación y demos van juntos.

**Archivos movidos a 04_ASSETS**:
- `__pycache__/` → `04_ASSETS/P2024_06_19_CLAW_PYCACHE_V01/`
- `.tmp.driveupload/` → `04_ASSETS/P2024_06_19_CLAW_TEMP_UPLOAD_V01/`
...
**Ejemplos**:
- `P2024_06_19_CLAW_CLAWSPRING_CORE_V01.py`
- `P2024_06_19_CLAW_PROVIDERS_V01.py`
- `P2024_06_19_CLAW_MEMORY_PACKAGE_V01/`

### Componentes del Formato

1. **AAAA-MM-DD**: Fecha de creación
   - `P2024_06_19_CLAW` = 19 de junio de 2024
...
- Cuándo se creó (P2024_06_19_CLAW)
...
# Tú aplicas la corrección a 01_SRC/P2024_06_19_CLAW_TOOLS_V01.py (P.A.R.A.)

# Corrección de Jules:
# Path.read_text() → Path.read_text(encoding='utf-8')

# Tú aplicas en archivo P.A.R.A.:
# 01_SRC/P2024_06_19_CLAW_TOOLS_V01.py
...
```python
# 01_SRC/P2024_06_19_CLAW_CLAWSPRING_CORE_V01.py
...
# 2. Lee el código
# 01_SRC/P2024_06_19_CLAW_THINKING_V01.py
# Línea 148
...
# 7. Haz commit
git add 01_SRC/P2024_06_19_CLAW_THINKING_V01.py
...
- **Semana 5-6**: Lee código de CLAW
  - `01_SRC/P2024_06_19_CLAW_CLAWSPRING_CORE_V01.py`
  - `01_SRC/P2024_06_19_CLAW_PROVIDERS_V01.py`
